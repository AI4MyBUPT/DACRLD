...
from models.AudioEncoder import Cnn10, ResNet38, Cnn14, TFEnc_FeatInput
from models.TextEncoder import BertEncoder, W2VEncoder, BertEmbInputEncoder
...
class ASE(nn.Module):
    ...
    def langevin_loss(self, audios, input_embeddings, input_attn_masks):
        audio_embed, caption_embed = self.forward(audios, input_embeddings, input_attn_masks)
