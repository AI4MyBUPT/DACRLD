"""
load hdf5 file, which contains the audio_name, audio_length, waveform, caption
get BEATs features: input: waveform and audio_length, output: BEATs features
save the BEATs features along with the original data to a new hdf5 file
"""
import os
import h5py
import librosa
...
feat_dir = 'data/AudioCaps/features/BEATs_iter3_plus_AS2M_finetuned_on_AS2M_cpt1/'
