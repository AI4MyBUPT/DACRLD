system = dict(
    ...
    notes='max_len_33_self_cond_BEATs',
    device=[7],
    note_eval=
    'beats_1e-5_norm924_langevin_coef_0.00001_step_size 0.1_step_count_3',
    seed=42,
    mode='test',
    debug=False,
    split_batches=True,
    ...
    ckpt_path=
    'output/1658.data_Clotho_latentTF_Extracted_scratch_v0.2_lr_0.0001_sche_cosine_warm_2000/best_val_ema_loss.pth'
)
...
diffusion = dict(
    ...
    langevin_sampling=dict(
        ...
        'pretrained_models/ase_embinput/bartemb_t4_beats_tf3ly_cls_norm924_distilbert_1e-5_data_Clotho_freeze_False_bs_22_lr_1e-05_margin_0.2_seed_20/models/best_model.pth',
        ase_mean_scale=
